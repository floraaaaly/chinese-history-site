...
export const xiangGroups: { name: string; ids: string[] }[] = [
  { name: '山', ids: ['duan-ge-xing', 'chun-wang', 'man-jiang-hong', 'jiang-xue', 'yin-jiu-wu', 'shan-ju-qiu-ming', 'chu-sai', 'yong-yu-le-jingkou', 'zuoqian-languan', 'guo-guren-zhuang', 'yu-jia-ao', 'guan-cang-hai', 'bo-chuan-guazhou', 'shi-hui-yin'] },
  ...
  { name: '关塞', ids: ['man-jiang-hong', 'song-yuan-er', 'chu-sai', 'zuoqian-languan', 'yu-jia-ao'] },
  ...
  { name: '风', ids: ['yu-mei-ren', 'chi-bi-dumu', 'guo-ling-tan', 'deng-gao', 'guan-cang-hai', 'bo-chuan-guazhou', 'jihai-zashi'] },
  { name: '禽鸟', ids: ['chun-wang', 'yin-jiu-wu', 'jin-se', 'chang-hen-ge'] },
  { name: '雪', ids: ['jiang-xue', 'mei-hua', 'zuoqian-languan'] },
  { name: '酒', ids: ['duan-ge-xing', 'song-yuan-er', 'jiang-jin-jiu'] },
  { name: '马', ids: ['gai-xia-ge', 'chu-sai', 'yong-yu-le-jingkou', 'jihai-zashi'] },
  { name: '柳', ids: ['song-yuan-er', 'sheng-cha-zi-yuanxi'] },
  { name: '雁', ids: ['sheng-sheng-man', 'yu-jia-ao'] },
